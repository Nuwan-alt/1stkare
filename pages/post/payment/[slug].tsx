...
export default function PostPaymentPage({ post }: Props) {
  ...
  function handleNothanks() {
    router.push(
      `/post/${encodeURIComponent(post.title?.toLowerCase())}/${post.alt_id}`
    )
  }
  ...
  async function handleCancelPayment() {
    ...
    try {
      ...
      router.push(`/post/${encodeURIComponent(post.title)}/${post.alt_id}`)
    } catch (e) {
      console.log(e)
    }
  }
              ...
              {isProcessing ? (
                ...
                <div>
                  ...
                  <PaypalButton
                    ...
                    onSuccess={(id) => {
                      router.push(
                        `/post/${encodeURIComponent(post.title)}/${post.alt_id}`
                      )
                    }}
                  />
                  ...
                  <Button
                    ...
                    /* onClick={() => router.push(`/post/${post.title?.toLowerCase().replace(/[^a-zA-Z0-9-_]/g, '')}/${post.alt_id}`   } */
                  >
                    {loading ? (
                      <CircularProgress size={26} color="inherit" />
                    ) : (
