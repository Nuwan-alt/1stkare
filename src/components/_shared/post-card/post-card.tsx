...
export default function PostCard(props: PostCardProps) {
  ...
  useEffect(() => {
    ...
    getRandomColor()
  }, [postUser.id]) // 👈️ empty dependencies array
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Box display="flex" className={styles['postcard-tag']}>
              ...
              <>
                {pageName !== 'seller-detail' &&
                  (postUser.public_phone ? (
                    ...
                    >
                      <PhoneCallIcon />{' '}
                      {formatPhoneNumber(postUser.public_phone)}
                    </Link>
                  ) : (
                    <span />
                  ))}
                ...
                {(!user || (user && postUser.id !== user.id)) &&
                  pageName !== 'seller-detail' && displayeChat && (
                    <div className={styles.postCard__chatmsg} id="chat_id">
                      <TextField
                        id="outlined-basic"
