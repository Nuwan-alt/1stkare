...
function SignUp(props: SignUpProps) {
  ...
  // const [is_email_login, setIsEmailLogin] = useState(false)
  ...
  const emailSignup = useAfterSignUp({
    onSuccess: async () => {
      setError(null)
      // await refreshUser()
      setFinished(true)
      // await router.push('/login')
      // console.log('setIsEmailLogin: ', setIsEmailLogin)

      logout()
      enqueueSnackbar('Verify your email - check your inbox', {
        variant: 'success',
      })
      setTimeout(async () => {
        // router.push('/login')
        ...
        .then(({ user }) => {
          user
            ...
            .then(() => {
              ...
              emailSignup(user!, input)
            })
        })
        .catch((setError) => {
          enqueueSnackbar('Email Signup Failed!', {
            variant: 'error',
          })
        })
  ...
  const continueWithFacebook = useCallback(() => {
    ...
    getAuth()
      ...
      .catch((setError) => {
        enqueueSnackbar('Facebook Signup Failed!', {
          variant: 'error',
        })
      })
      .finally(() => setLoading(false))
  ...
  const continueWithApple = useCallback(() => {
    ...
    getAuth()
      ...
      .then(({ user }) => afterSignUp(user!, input))
      .catch((setError) => {
        enqueueSnackbar('Apple Signup Failed!', {
          variant: 'error',
        })
      })
      .finally(() => setLoading(false))
